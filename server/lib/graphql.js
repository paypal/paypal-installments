...
export type GraphQL = (
  ExpressRequest,
  $ReadOnlyArray<{| query: string, variables: Object |}>,
  opts?: {| accessToken?: string, clientMetadataID?: string |}
) => Promise<$ReadOnlyArray<{| result: Object |}>>;
...
export function buildQuery<I, V>({
  name,
  key,
  inputTypes,
  inputs,
  query,
}: BuildQueryOptions<I, V>): ?string {
