...
import {
  BUTTON_RENDER_MODULE,
  BUTTON_CLIENT_MODULE,
  MODULE_POLL_INTERVAL,
  SDK_CDN_NAMESPACE,
  SMART_BUTTONS_CDN_NAMESPACE,
  BUTTON_RENDER_CHILD_MODULE,
} from "./config";
...
export const getPayPalSDKWatcher = ({
  logBuffer,
  cache,
}: {|
...
export const getPayPalSmartPaymentButtonsWatcher = ({
  logBuffer,
  cache,
}: {|
  logBuffer: ?LoggerBufferType,
...
export function startWatchers({
  logBuffer,
  cache,
}: {| logBuffer: ?LoggerBufferType, cache: ?CacheType |} = {}) {
